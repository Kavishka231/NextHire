...
def serialize_job(job: Job):
    ...
    return {
        ...
        "additional_qualifications": job.additional_qualifications,
        "schedule_expectations": job.schedule_expectations,
...
def create_company_job(
    ...
    job = Job(
        ...
        company_description=data.company_description or current_user.company_description,
        ...
        schedule_expectations=data.schedule_expectations,
